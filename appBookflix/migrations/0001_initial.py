# Generated by Django 2.2.14 on 2020-07-14 20:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, null=True, verbose_name='descripcion')),
                ('mostrar_en_home', models.BooleanField(default=False)),
                ('imagen', models.ImageField(upload_to='novedades', verbose_name='imagen')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('up', models.DateField(default=datetime.datetime(2020, 7, 14, 20, 13, 56, 342238, tzinfo=utc), validators=[appBookflix.models.esCorrecto], verbose_name='DarDeAlta')),
                ('expirationl', models.DateField(default=datetime.datetime(2020, 7, 14, 20, 13, 56, 342268, tzinfo=utc), validators=[appBookflix.models.esCorrecto], verbose_name='DarDeBaja')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('up', models.DateField(default=datetime.datetime(2020, 7, 14, 20, 13, 56, 341736, tzinfo=utc), validators=[appBookflix.models.esCorrecto], verbose_name='DarDeAlta')),
                ('expirationl', models.DateField(default=datetime.datetime(2020, 7, 14, 20, 13, 56, 341763, tzinfo=utc), validators=[appBookflix.models.esCorrecto], verbose_name='DarDeBaja')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('up', models.DateField(default=datetime.datetime(2020, 7, 14, 20, 13, 56, 341137, tzinfo=utc), validators=[appBookflix.models.esCorrecto], verbose_name='DarDeAlta')),
                ('expirationl', models.DateField(default=datetime.datetime(2020, 7, 14, 20, 13, 56, 341164, tzinfo=utc), validators=[appBookflix.models.esCorrecto], verbose_name='DarDeBaja')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('up_normal', models.DateField(default=datetime.datetime(2020, 7, 14, 20, 13, 56, 340603, tzinfo=utc), validators=[appBookflix.models.esCorrecto], verbose_name='programar publicación')),
                ('expiration_normal', models.DateField(default=datetime.datetime(2020, 7, 14, 20, 13, 56, 340631, tzinfo=utc), validators=[appBookflix.models.esCorrecto], verbose_name='programar expiración')),
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='appBookflix.BookByChapter', verbose_name='libro')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('up_normal', models.DateField(default=datetime.datetime(2020, 7, 14, 20, 13, 56, 339990, tzinfo=utc), validators=[appBookflix.models.esCorrecto], verbose_name='programar publicación')),
                ('expiration_normal', models.DateField(default=datetime.datetime(2020, 7, 14, 20, 13, 56, 340029, tzinfo=utc), validators=[appBookflix.models.esCorrecto], verbose_name='programar expiración')),
                ('up_premium', models.DateField(default=datetime.datetime(2020, 7, 14, 20, 13, 56, 340051, tzinfo=utc), validators=[appBookflix.models.esCorrecto], verbose_name='pasar a premium')),
                ('expiration_premium', models.DateField(default=datetime.datetime(2020, 7, 14, 20, 13, 56, 340070, tzinfo=utc), validators=[appBookflix.models.esCorrecto], verbose_name='expiracion premium')),
