# Generated by Django 2.2.14 on 2020-07-10 12:44
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('up', models.DateField(default=datetime.datetime(2020, 7, 10, 12, 44, 25, 801539, tzinfo=utc), validators=[appBookflix.models.esCorrecto], verbose_name='DarDeAlta')),
                ('expirationl', models.DateField(default=datetime.datetime(2020, 7, 10, 12, 44, 25, 801563, tzinfo=utc), validators=[appBookflix.models.esCorrecto], verbose_name='DarDeBaja')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('up', models.DateField(default=datetime.datetime(2020, 7, 10, 12, 44, 25, 801101, tzinfo=utc), validators=[appBookflix.models.esCorrecto], verbose_name='DarDeAlta')),
                ('expirationl', models.DateField(default=datetime.datetime(2020, 7, 10, 12, 44, 25, 801127, tzinfo=utc), validators=[appBookflix.models.esCorrecto], verbose_name='DarDeBaja')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('up', models.DateField(default=datetime.datetime(2020, 7, 10, 12, 44, 25, 800641, tzinfo=utc), validators=[appBookflix.models.esCorrecto], verbose_name='DarDeAlta')),
                ('expirationl', models.DateField(default=datetime.datetime(2020, 7, 10, 12, 44, 25, 800664, tzinfo=utc), validators=[appBookflix.models.esCorrecto], verbose_name='DarDeBaja')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('up_normal', models.DateField(default=datetime.datetime(2020, 7, 10, 12, 44, 25, 800126, tzinfo=utc), validators=[appBookflix.models.esCorrecto], verbose_name='pasar a normal')),
                ('expiration_normal', models.DateField(default=datetime.datetime(2020, 7, 10, 12, 44, 25, 800150, tzinfo=utc), validators=[appBookflix.models.esCorrecto], verbose_name='expiracion normal')),
                ('up_premium', models.DateField(default=datetime.datetime(2020, 7, 10, 12, 44, 25, 800167, tzinfo=utc), validators=[appBookflix.models.esCorrecto], verbose_name='pasar a premium')),
                ('expiration_premium', models.DateField(default=datetime.datetime(2020, 7, 10, 12, 44, 25, 800185, tzinfo=utc), validators=[appBookflix.models.esCorrecto], verbose_name='expiracion premium')),
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='appBookflix.BookByChapter', verbose_name='libro')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('up_normal', models.DateField(default=datetime.datetime(2020, 7, 10, 12, 44, 25, 799574, tzinfo=utc), validators=[appBookflix.models.esCorrecto], verbose_name='pasar a normal')),
                ('expiration_normal', models.DateField(default=datetime.datetime(2020, 7, 10, 12, 44, 25, 799608, tzinfo=utc), validators=[appBookflix.models.esCorrecto], verbose_name='expiracion normal')),
                ('up_premium', models.DateField(default=datetime.datetime(2020, 7, 10, 12, 44, 25, 799628, tzinfo=utc), validators=[appBookflix.models.esCorrecto], verbose_name='pasar a premium')),
                ('expiration_premium', models.DateField(default=datetime.datetime(2020, 7, 10, 12, 44, 25, 799650, tzinfo=utc), validators=[appBookflix.models.esCorrecto], verbose_name='expiracion premium')),
